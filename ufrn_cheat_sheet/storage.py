# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_sqlite.ipynb.

# %% auto 0
__all__ = ['ReadOnlyInMemorySQLite']

# %% ../nbs/02_sqlite.ipynb 3
import sqlite3
import pandas as pd

# %% ../nbs/02_sqlite.ipynb 6
class ReadOnlyInMemorySQLite:
    def __init__(self):
        ...
        try:
            self.load_csv_as_table('taxa_aprovacao_por_componente.csv', 'data')
